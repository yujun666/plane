...
function start(){
    ...
    if(mark==20){
        mark1++;
        //中飞机 hp,X,Y,sizeX,sizeY,score,dietime,sudu,boomimage,imagesrc
        if(mark1%5==0){
            enemys.push(new enemy(6,25,274,46,60,500,360,random(1,3),"image/zz.gif","image/enemy3_fly_1.png"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,57,210,110,164,3000,540,1,"image/dd.gif","image/enemy2_fly_1.png"));
            mark1=0;
        }
        //小飞机
        else{
            enemys.push(new enemy(1,19,286,34,24,100,360,random(1,4),"image/xx.gif","image/enemy1_fly_1.png"));
        }
        mark=0;
    }
